...
def _transfer_suit(ctx: AuctionContext) -> Suit:
...
def _texas_suit(ctx: AuctionContext) -> Suit:
...
def _transfer_suit_2nt(ctx: AuctionContext) -> Suit:
...
def _partner_bid_suit(ctx: AuctionContext) -> Suit:
